  ...
  return (
    <section className=''>
      ...
      <section className='bg-[#434141]'>
        <div className='flex flex-col lg:justify-center pl-8 lg:pl-0 lg:flex-row mx-auto w-full  lg:max-w-7xl font-manrope pt-12 pb-4  text-white'>
          Follow us on:
          <div className='flex mt-4 lg:mt-0 text-white ml-2 gap-x-2'>
